package org.danny.common.chart.fusioncharts;
...
public class Chart {
    ...
    private Integer showyaxisvalues;
    ...
    private Integer tooltipborderalpha;
    private Integer adaptiveymin;
    ...
    public Integer getAdaptiveymin() {
        return adaptiveymin;
    }

    public void setAdaptiveymin(Integer adaptiveymin) {
    ...
    public Integer getShowyaxisvalues() {
        return showyaxisvalues;
    }

    public void setShowyaxisvalues(Integer showyaxisvalues) {
    ...
    public Integer getTooltipborderalpha() {
        return tooltipborderalpha;
    }

    public void setTooltipborderalpha(Integer tooltipborderalpha) {
