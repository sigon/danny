...
public class ServiceImplGenerator extends BaseGenerator {
    ...
    public void trans(Map<String, Object> map) {
        ...
        staticPath = generate.getServicePath() + "/" + generate.getServicePackage().replaceAll("\\.", "/") + "/" + bean.getTable() + "/impl/" + StringUtils.capitalize(bean.getTable()) + "ServiceImpl.java";
